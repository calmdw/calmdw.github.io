...
My research focus on robot learning and robotic manipulation. Recently I am using using reinforcement learning methods to achieve generalizable and high-precision robotic assembly. IsaacLab(IsaacSim) is my current favorite RL frame and simulator. Applying my knowledge to output meaningful Welcome for small chat about reinforcement learning, imitation learning and sim2real. 
